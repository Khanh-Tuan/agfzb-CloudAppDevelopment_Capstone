...
def get_dealerships(request):
    context = {}
    if request.method == "GET":
        url = "https://fc49f1a3.au-syd.apigw.appdomain.cloud/api/dealership"
...
def get_dealer_details(request, dealer_id):
    ...
    if request.method == "GET":
        ...
        url2 = "https://fc49f1a3.au-syd.apigw.appdomain.cloud/api/review"
        # Get dealers from the URL
...
def add_review(request, dealer_id):
    context = {}
    dealer_url = "https://fc49f1a3.au-syd.apigw.appdomain.cloud/api/review"
    ...
    if request.method == 'GET':
        ...
        if request.user.is_authenticated:
            ...
            review_post_url = "https://fc49f1a3.au-syd.apigw.appdomain.cloud/api/review"

...
def get_dealer_reviews_from_cf(url, **kwargs):
    ...
    json_result = get_request(url, delaerID=dealer_id)
    if json_result:
        ...
        for review in reviews:
            if review['purchase'] == True:
                review_obj = DealerReview(car_make=review["car_make"], car_model=review["car_model"],
                                        ...
                                        purchase_date=review["purchase-date"], revoew=review["review"],
...
def analyze_review_sentiments(dealerreview):
    url = 'https://api.au-syd.natural-language-understanding.watson.cloud.ibm.com/instances/10566cd1-206f-4d0f-9662-a22446178e4e'
    api_key = '4lNUleaHxhgkdHF2yuOn3q0BmRA-Z6wUxnTvLebhIKWR'
